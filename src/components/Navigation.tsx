          ...
          <div className="hidden lg:flex items-center gap-8">
            {navLinks.map((link) => (
              <Link
                key={link.path}
                to={link.path}
                className={`elegant-underline text-sm uppercase tracking-widest font-medium transition-colors duration-300 ${
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 top-0 bg-background/98 backdrop-blur-xl lg:hidden z-40"
          >
